    ...
    <div className="space-y-5 pb-12 animate-in fade-in duration-400">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0E1220] border border-white/8 rounded-2xl w-full max-w-md shadow-[0_32px_80px_rgba(0,0,0,0.6)] animate-in zoom-in-95 fade-in duration-200 max-h-[90dvh] overflow-y-auto">
